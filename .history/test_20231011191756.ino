...
void loop() {
  ...
  if (nutNhan1 == 0) {
    ...
    while (true) {
      ...
      analogWrite(PWM2, 0);
      if ((sensorVal[7] == 1) && (sensorVal[6] == 1) && (sensorVal[5] == 1) && (sensorVal[4] == 1) && (sensorVal[3] == 1) && (sensorVal[2] == 1) && (sensorVal[1] == 1) && (sensorVal[0] == 1)) {
        count++;
        switch (count) {
          case 1:
            //reTrai()
      ...
      } else if ((sensorVal[7] == 0) && (sensorVal[6] == 0) && (sensorVal[5] == 0) && (sensorVal[4] == 1) && (sensorVal[3] == 1) && (sensorVal[2] == 1) && (sensorVal[1] == 1) && (sensorVal[0] == 1) || (sensorVal[7] == 0) && (sensorVal[6] == 0) && (sensorVal[5] == 0) && (sensorVal[4] == 0) && (sensorVal[3] == 1) && (sensorVal[2] == 1) && (sensorVal[1] == 1) && (sensorVal[0] == 1) || (sensorVal[7] == 0) && (sensorVal[6] == 0) && (sensorVal[5] == 1) && (sensorVal[4] == 1) && (sensorVal[3] == 1) && (sensorVal[2] == 1) && (sensorVal[1] == 1) && (sensorVal[0] == 1)) {
        count++;
        switch (count) {
          case :1
            //reTrai()
