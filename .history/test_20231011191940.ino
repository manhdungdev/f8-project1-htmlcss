...
void loop() {
  ...
  if (nutNhan1 == 0) {
    ...
    while (true) {
      ...
      } else if ((sen[7] == 0) && (sen[6] == 0) && (sen[5] == 0) && (sen[4] == 1) && (sen[3] == 1) && (sen[2] == 1) && (sen[1] == 1) && (sen[0] == 1) || (sen[7] == 0) && (sen[6] == 0) && (sen[5] == 0) && (sen[4] == 0) && (sen[3] == 1) && (sen[2] == 1) && (sen[1] == 1) && (sen[0] == 1) || (sen[7] == 0) && (sen[6] == 0) && (sen[5] == 1) && (sen[4] == 1) && (sen[3] == 1) && (sen[2] == 1) && (sen[1] == 1) && (sen[0] == 1)) {
        count++;
        switch (count) {
          case :1
            //reTrai()
